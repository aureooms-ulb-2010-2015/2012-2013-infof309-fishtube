#ifndef VIDEOSTREAMPROCESSING_H
#define VIDEOSTREAMPROCESSING_H
...
public:
    ...
    VideoStreamProcessor() : callIt(false), delay(-1),
    ...
    bool setFrameNumber(long unsigned pos) {
